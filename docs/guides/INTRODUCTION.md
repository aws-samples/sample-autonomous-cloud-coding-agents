...
For how channels, orchestrator, agent, and outcomes fit together, see [How the platform works](./concepts/HOW_THE_PLATFORM_WORKS.md).
...
See [All use cases](./use-cases/USE_CASES_INDEX.md) for outcome-first tutorials.
...
- **Evaluators** — understand the platform before deploy; start with [Concepts](./concepts/HOW_THE_PLATFORM_WORKS.md)
- **Contributors** — extend the CDK app, agent runtime, or CLI

## Next steps

- [Quick Start](./QUICK_START.mdx) — deploy and submit your first task (~30 min)
- [How the platform works](./concepts/HOW_THE_PLATFORM_WORKS.md) — end-to-end story and fundamentals
- [All use cases](./use-cases/USE_CASES_INDEX.md) — outcome-first tutorials
