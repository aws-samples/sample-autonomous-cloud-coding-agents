...
- [Blueprint vs workflow](./blueprint-vs-workflow.md) — per-repo settings vs task kind
- [Orchestrator and agent](./orchestrator-and-agent.md) — who runs the task
- [Using workflows](../../USER_GUIDE.md#workflows) — which workflow when

## Deep dive

- [WORKFLOWS.md](../../../design/WORKFLOWS.md) — workflow catalog and resolution
- [Task lifecycle](../../USER_GUIDE.md#task-lifecycle) — states and transitions (operational detail)
