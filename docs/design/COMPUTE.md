...
and retain it until completing the [resource migration](../verification/645-p3-nested-stack.md).
...
Agents can use configured skills and MCP tools through the [registry](./REGISTRY.md). Their runtime network access remains subject to the compute backend’s egress rules.
