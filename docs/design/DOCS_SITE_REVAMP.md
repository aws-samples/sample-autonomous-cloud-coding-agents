...
This document defines goals, requirements, and a phased plan to revamp the site for **operators**, **daily users**, **knowledge workers**, and **contributors** — while keeping the existing source-first + sync pipeline and [ADR-004 tabula rasa](./../decisions/ADR-004-tabula-rasa-documentation.md) standard.
...
2. **Pick source path** per [docs/AGENTS.md](../AGENTS.md):
...
**Problem:** Today, “harness” is defined only in [COMPUTE.md](./COMPUTE.md); “blueprint vs workflow” only in [WORKFLOWS.md](./WORKFLOWS.md). Customers should not need architecture deep dives to learn basic vocabulary.
...
## Related concepts
- [Blueprint vs workflow](./blueprint-vs-workflow.md) (Level 100)
- [Task lifecycle](../level-200/task-lifecycle.md) (Level 200)
...
|-----------------|-------|-------------------|
| Submit your first coding task from the terminal | [Using the CLI](../guides/USER_GUIDE.md#using-the-cli) tutorial | `coding/new-task-v1` · CLI |
| Auto-review every new PR | [PR review webhook tutorial](../guides/use-cases/automated-pr-review.md) | `coding/pr-review-v1` · webhook |
| Address review comments on an open PR | [Workflows](../guides/USER_GUIDE.md#workflows) (`coding/pr-iteration-v1`) | `coding/pr-iteration-v1` · CLI `--pr` |
...
| Run research without a GitHub repo | [Web research tutorial](../guides/use-cases/web-research-brief.md) | `knowledge/web-research-v1` |
| Understand how the platform works (no deploy yet) | [Concepts hub](../guides/concepts/HOW_THE_PLATFORM_WORKS.md) → Level 100 | — |
| Learn what “harness” and “blueprint” mean | [Agent harness](../guides/concepts/level-100/agent-harness.md) · [Blueprint vs workflow](../guides/concepts/level-100/blueprint-vs-workflow.md) | Concepts |
...
3. **Capability tiles** (mirror Ona's pattern: computer, workflows, tools, guardrails, audit):
   ...
   - **Workflow-driven tasks** — versioned YAML, not hardcoded branches ([WORKFLOWS.md](./WORKFLOWS.md))
...
- [COMPUTE.md](./COMPUTE.md) — agent harness definition (source for Level 100 harness page)
- [ADR-004: Tabula rasa documentation](../decisions/ADR-004-tabula-rasa-documentation.md) — glossary + terminology consistency
- [docs/AGENTS.md](../AGENTS.md) — package commands and boundaries
- [ARCHITECTURE.md](./ARCHITECTURE.md) — platform architecture corpus
- [DEVELOPER_GUIDE.md](../guides/DEVELOPER_GUIDE.md) — contributor orientation
...
- [WORKFLOWS.md](./WORKFLOWS.md) — workflow domains, `requires_repo`, repo-optional tasks
