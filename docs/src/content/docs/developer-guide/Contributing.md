...
Follow the [Quick Start](/getting-started/quick-start) to clone, install, and build the project. See the [Developer guide](/developer-guide/introduction) for local testing and the development workflow.
...
- For structured reviews (human or agent), use the [`review_pr` command](/architecture/review-pr) — including the **human review heuristics** (Proportionality, Coherence, Clarity, Appropriateness) for smell dimensions automation cannot catch.
