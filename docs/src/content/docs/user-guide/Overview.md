...
4. **Slack** — Submit tasks, check status, and receive notifications directly in Slack via the `/bgagent` slash command. See the [Slack setup guide](/design/slack-setup-guide).