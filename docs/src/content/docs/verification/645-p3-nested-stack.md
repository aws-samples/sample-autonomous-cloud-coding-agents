...
[deployment roles](/sample-autonomous-cloud-coding-agents/architecture/deployment-roles) and the
[artifact packaging instructions](https://github.com/aws-samples/sample-autonomous-cloud-coding-agents/blob/main/cdk/scripts/README.md).
...
constitute that tool. Track remaining acceptance in [verification status](/sample-autonomous-cloud-coding-agents/verification/readme#open-pr-checks).
