...
**Related:** [CEDAR_HITL_GATES.md](/sample-autonomous-cloud-coding-agents/architecture/cedar-hitl-gates), [INTERACTIVE_AGENTS.md](/sample-autonomous-cloud-coding-agents/architecture/interactive-agents), [ORCHESTRATOR.md](/sample-autonomous-cloud-coding-agents/architecture/orchestrator), [SECURITY.md](/sample-autonomous-cloud-coding-agents/architecture/security).
