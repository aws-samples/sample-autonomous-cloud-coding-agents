...
**Related:** [CEDAR_HITL_GATES.md](/architecture/cedar-hitl-gates), [INTERACTIVE_AGENTS.md](/architecture/interactive-agents), [ORCHESTRATOR.md](/architecture/orchestrator), [SECURITY.md](/architecture/security).
