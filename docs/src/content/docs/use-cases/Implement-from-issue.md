...
See [Task and workflow](/sample-autonomous-cloud-coding-agents/architecture/task-and-workflow) and [Orchestrator and agent](/sample-autonomous-cloud-coding-agents/architecture/orchestrator-and-agent). Platform steps: admission → hydration → pre-flight → agent execution → finalization ([Architecture](/sample-autonomous-cloud-coding-agents/architecture/architecture)).

## If something fails

| Symptom | Fix |
|---------|-----|
| `REPO_NOT_FOUND_OR_NO_ACCESS` | [Troubleshooting — GitHub PAT](/sample-autonomous-cloud-coding-agents/troubleshooting/troubleshooting#repo_not_found_or_no_access--github-pat) |
...
- [Automated PR review](/sample-autonomous-cloud-coding-agents/architecture/automated-pr-review)
- [Iterate on review feedback](/sample-autonomous-cloud-coding-agents/using/workflows) with `coding/pr-iteration-v1`
