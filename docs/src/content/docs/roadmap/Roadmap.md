...
- [x] **Jira integration** - Label-triggered tasks on Jira Cloud, `bgagent jira setup` / `map` / `link`, progress comments via Atlassian Remote MCP. See [JIRA_SETUP_GUIDE.md](/using/jira-setup-guide)
