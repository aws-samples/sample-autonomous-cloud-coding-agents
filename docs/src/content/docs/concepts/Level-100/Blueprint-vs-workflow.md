...
- [Cedar policy guide](/sample-autonomous-cloud-coding-agents/customizing/cedar-policies) — authoring rules
- [Repository onboarding](/sample-autonomous-cloud-coding-agents/customizing/repository-onboarding)

## Deep dive

- [REPO_ONBOARDING.md](/sample-autonomous-cloud-coding-agents/architecture/repo-onboarding)
- [WORKFLOWS.md](/sample-autonomous-cloud-coding-agents/architecture/workflows)
