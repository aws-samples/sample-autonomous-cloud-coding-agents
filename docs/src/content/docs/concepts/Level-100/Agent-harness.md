...
- [Orchestrator and agent](/sample-autonomous-cloud-coding-agents/architecture/orchestrator-and-agent)
- [Blueprint vs workflow](/sample-autonomous-cloud-coding-agents/architecture/blueprint-vs-workflow)
- [What the agent does](/sample-autonomous-cloud-coding-agents/using/what-the-agent-does) — operational view

## Deep dive

- [COMPUTE.md](/sample-autonomous-cloud-coding-agents/architecture/compute) — harness section and constraints
- [SECURITY.md](/sample-autonomous-cloud-coding-agents/architecture/security) — tool policy and isolation
