...
- [Agent harness](/sample-autonomous-cloud-coding-agents/architecture/agent-harness) — loop around the model inside compute
- [Task and workflow](/sample-autonomous-cloud-coding-agents/architecture/task-and-workflow)
- [COMPUTE.md](/sample-autonomous-cloud-coding-agents/architecture/compute) — MicroVM isolation

## Deep dive

- [ORCHESTRATOR.md](/sample-autonomous-cloud-coding-agents/architecture/orchestrator)
- [ARCHITECTURE.md](/sample-autonomous-cloud-coding-agents/architecture/architecture) — blueprint step model
