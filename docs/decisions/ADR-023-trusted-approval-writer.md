...
- Existing deployments must pause submissions, drain old workers and deploy
  ...
  [upgrade procedure](../guides/DEPLOYMENT_GUIDE.md#upgrading-approval-permissions).
...
- [Approval trust boundaries](../design/CEDAR_HITL_GATES.md#121-trust-boundaries)
- [ADR-021: Lambda MicroVM compute backend](./ADR-021-lambda-microvms-compute-backend.md)
