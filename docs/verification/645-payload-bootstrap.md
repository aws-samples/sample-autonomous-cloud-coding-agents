...
The [ADR wire contract](../decisions/ADR-021-lambda-microvms-compute-backend.md#3-packaging-same-agent-image-source-new-build-path)
and [security design](../design/SECURITY.md) describe its trust boundary.
...
those workers drain; follow the [migration prerequisites](./645-p3-nested-stack.md).
...
See [recorded acceptance and remaining checks](./README.md).
